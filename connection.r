...
hive_url <- "jdbc:hive2://sdpsvrwm0217.scglobal.ad.scotiacapital.com:8443/;ssl=true;sslTrustStore=C:/HiveJars/gateway.jks;trustStorePassword=Test123?hive.server2.transport.mode=http;hive.server2.thrift.http.path=gateway/default/hive"
